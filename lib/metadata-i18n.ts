...
const META: Record<PageKey, Record<Locale, MetaEntry>> = {
  ...
  home: {
    en: {
      title: "Okelcor | Tyre Wholesale & Export, Munich",
      ...
      ogTitle: "Okelcor | Tyre Wholesale & Export, Munich",
    ...
    de: {
      ...
      ogTitle: "Okelcor | Reifengroßhandel & Export, München",
      ...
      twitterTitle: "Okelcor | Reifengroßhandel & Export, München",
      twitterDescription: "PKW-, LKW- und Gebrauchtreifen für Händler weltweit.",
    },
    fr: {
      title: "Okelcor | Grossiste et export de pneus, Munich",
      ...
      ogTitle: "Okelcor | Grossiste et export de pneus, Munich",
      ...
      twitterTitle: "Okelcor | Grossiste et export de pneus, Munich",
      twitterDescription: "Pneus PCR, TBR et d'occasion pour les distributeurs du monde entier.",
    },
    es: {
      title: "Okelcor | Mayorista y exportación de neumáticos, Múnich",
      ...
      ogTitle: "Okelcor | Mayorista y exportación de neumáticos, Múnich",
      ...
      twitterTitle: "Okelcor | Mayorista y exportación de neumáticos, Múnich",
