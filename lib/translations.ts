...
const en: Translations = {
  ...
  quote: {
    ...
    form: {
      ...
      errGeneric: "Something went wrong. Please try again or contact us directly at support@okelcor.de.",
  ...
  contact: {
    ...
    errGeneric: "Something went wrong. Please try again or email us directly at support@okelcor.de.",
  ...
  checkout: {
    ...
    tax: "Tax", taxNote: "Calculated on invoice", total: "Total",
    taxDisclaimer: "Excl. applicable taxes · Final amount confirmed on order",
    qty: "Qty", each: "each",
...
const de: Translations = {
  ...
  quote: {
    ...
    form: {
      ...
      errGeneric: "Etwas ist schiefgelaufen. Bitte versuchen Sie es erneut oder kontaktieren Sie uns direkt unter support@okelcor.de.",
  ...
  contact: {
    ...
    errGeneric: "Etwas ist schiefgelaufen. Bitte versuchen Sie es erneut oder schreiben Sie uns direkt an support@okelcor.de.",
  ...
  checkout: {
    ...
    subtotal: "Zwischensumme", delivery: "Versand", free: "Kostenlos",
    tax: "MwSt.", taxNote: "Wird auf der Rechnung berechnet", total: "Gesamt",
    taxDisclaimer: "Ohne ggf. anfallende Steuern · Endbetrag wird mit der Bestellung bestätigt",
    qty: "Menge", each: "je",
...
const fr: Translations = {
  ...
  quote: {
    ...
    form: {
      ...
      errGeneric: "Une erreur s'est produite. Veuillez r\u00e9essayer ou nous contacter directement \u00e0 support@okelcor.de.",
  ...
  contact: {
    ...
    errGeneric: "Une erreur s'est produite. Veuillez réessayer ou nous écrire directement à support@okelcor.de.",
  ...
  checkout: {
    ...
    subtotal: "Sous-total", delivery: "Livraison", free: "Gratuit",
    tax: "TVA", taxNote: "Calculée sur facture", total: "Total",
    taxDisclaimer: "Hors taxes applicables · Montant final confirmé à la commande",
...
const es: Translations = {
  ...
  quote: {
    ...
    form: {
      ...
      errGeneric: "Algo salió mal. Inténtelo de nuevo o contáctenos directamente en support@okelcor.de.",
  ...
  checkout: {
    ...
    subtotal: "Subtotal", delivery: "Envío", free: "Gratis",
    tax: "IVA", taxNote: "calculado al tramitar", total: "Total", taxDisclaimer: "IVA incluido si aplica",
    qty: "Cant.", each: "c/u",
