...
const en: Translations = {
  ...
  quote: {
    ...
    form: {
      ...
      errGeneric: "Something went wrong. Please try again or contact us directly at info@okelcor.de.",
  ...
  contact: {
    ...
    errGeneric: "Something went wrong. Please try again or email us directly at info@okelcor.de.",
...
const de: Translations = {
  ...
  quote: {
    ...
    form: {
      ...
      errGeneric: "Etwas ist schiefgelaufen. Bitte versuchen Sie es erneut oder kontaktieren Sie uns direkt unter info@okelcor.de.",
  ...
  contact: {
    ...
    errGeneric: "Etwas ist schiefgelaufen. Bitte versuchen Sie es erneut oder schreiben Sie uns direkt an info@okelcor.de.",
...
const fr: Translations = {
  ...
  quote: {
    ...
    form: {
      ...
      errGeneric: "Une erreur s'est produite. Veuillez r\u00e9essayer ou nous contacter directement \u00e0 info@okelcor.de.",
  ...
  contact: {
    ...
    errGeneric: "Une erreur s'est produite. Veuillez réessayer ou nous écrire directement à info@okelcor.de.",
...
const es: Translations = {
  ...
  quote: {
    ...
    form: {
      ...
      errGeneric: "Algo salió mal. Inténtelo de nuevo o contáctenos directamente en info@okelcor.de.",
