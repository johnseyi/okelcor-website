...
const STATUS_OPTIONS = ["all", "new", "reviewed", "quoted", "closed"] as const;
...
export default function QuotesTable({
  quotes, meta, currentStatus, currentQ, currentPage,
}: Props) {
          ...
          <table className="w-full min-w-[760px] text-left">
            <thead>
              <tr className="border-b border-black/[0.06] bg-[#fafafa]">
                {["Ref", "Requester", "Category", "Country", "Qty", "Status", "Date", ""].map((h) => (
