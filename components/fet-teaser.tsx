      ...
      <div className="tesla-shell flex flex-col items-center justify-between gap-6 text-center sm:flex-row sm:text-left">
        ...
        <div className="flex flex-col gap-2">
          ...
          <h2 className="text-[1.15rem] font-extrabold leading-snug tracking-tight text-[#111111] sm:text-[1.25rem]">
            {t.fetTeaser.title} —{" "}
            <span className="text-[#f4511e]">{t.fetTeaser.highlight}</span>
          </h2>
        ...
        <Link
          href="/fet"
          className="inline-flex shrink-0 items-center gap-2 rounded-full bg-[#f4511e] px-6 py-3 text-[0.88rem] font-semibold text-white shadow-[0_8px_24px_rgba(34,197,94,0.25)] transition hover:bg-[#df4618]"
        >
