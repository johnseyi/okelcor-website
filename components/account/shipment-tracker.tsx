...
import { RefreshCw, MapPin, Ship, Anchor, Calendar, Package } from "lucide-react";
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <InfoChip
          icon={<Ship size={12} strokeWidth={2} />}
          label="Vessel"
          value={vessel}
        />
        <InfoChip
        ...
        />
        <InfoChip
          icon={<Anchor size={12} strokeWidth={2} />}
        ...
        <div>
          ...
          <div className="flex items-start gap-3 rounded-[12px] border border-black/[0.07] bg-white px-4 py-3">
            ...
            <div className="flex flex-col gap-0.5">
              {latestEvent.date && (
                <p className="text-[0.73rem] font-semibold text-[var(--muted)]">
                  {latestEvent.date}
                </p>
              )}
