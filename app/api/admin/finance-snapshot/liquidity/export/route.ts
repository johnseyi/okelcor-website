...
/**
 * GET — finance.snapshot. The liquidity Details ledger as a BOM-prefixed CSV in the import-compatible
 * column layout, piped through with Content-Disposition preserved.
 */
export async function GET(_req: NextRequest) {
  ...
  try {
    const res = await fetch(`${ADMIN_BASE}/finance-snapshot/liquidity/export`, {
